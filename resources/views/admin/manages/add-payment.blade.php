        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 col-md-12">
                <div class="card shadow-lg border-0 rounded-lg">
                    <div class="card-header bg-info"><h3 class="text-center font-weight-light my-4">Add Payment Info</h3></div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('new-payment-info') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <strong><mark>Bkash</mark></strong>
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="inputFirstName" type="text" name="bkash_number" placeholder="Enter Tour Title" />
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="inputFirstName" type="text" name="nagad_number" placeholder="Enter Tour Title" />
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="inputFirstName" type="text" name="rocket_number" placeholder="Enter Tour Title" />
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3 mb-md-0">
                                        <input class="form-control" id="inputFirstName" type="text" name="bank_acc_number" placeholder="Enter Tour Title" />
                            ...
                            <div class="row mb-3">
                                <div class="mt-4 mb-0">
                                    <input class="form-control btn btn-success" type="submit" value="Add This Payment Info">
                                </div>
                        </form>
                    </div>
